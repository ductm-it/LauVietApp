...
import com.example.myshop.adapter.RauAdapter;
...
public class RauActivity extends AppCompatActivity {
    androidx.appcompat.widget.Toolbar toolbarrau;
    ListView listViewrau;
    RauAdapter rauAdapter;
    ArrayList<SanPham> mangrau;
    ...
    private void AnhXa() {
        toolbarrau=(Toolbar) findViewById(R.id.toolbarrau);
        listViewrau=(ListView) findViewById(R.id.listviewrau);
        //truyền dữ liệu vào mảng
        mangrau=new ArrayList<>();
        rauAdapter =new RauAdapter(getApplicationContext(),mangrau);
        listViewrau.setAdapter(rauAdapter);
        //processbar footer
    ...
    private void GetIdLoaiSP() {
        idrau=getIntent().getIntExtra("idloaisanpham",-1);
        Log.d("giatriloaisanpham",idrau+"");
    }
    private void ActionToolbar() {
        setSupportActionBar(toolbarrau);
        //nút home
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        toolbarrau.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, duongdan, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response!=null && response.length()!=2){
                     listViewrau.removeFooterView(footerview);
                    try {
                        ...
                        for (int i=0;i<jsonArray.length();i++){
                            ...
                            mangrau.add((new SanPham(ID,Tensanpham,Hinhanhsanpham,Giasanpham,Mau,ChatLieu,Motasanpham,IDtype)));
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("id_type",String.valueOf(idrau));
                return map;
            }
        };
    ...
    private void LoadMoreData() {
        //chi tiet san pham
        listViewrau.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //chuyển màn hình
                Intent intent=new Intent(getApplicationContext(),ChiTietSanPham.class);
                SanPham product = (SanPham) rauAdapter.getItem(position);
        ...
        //sự kiện kéo xuống
        listViewrau.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    public class mHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what){
                case 0:
                    listViewrau.addFooterView(footerview);
                    break;
                case 1:
                    GetData(++page);
                    isLoading=false;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                final List<SanPham> filterModList = filter(mangrau, newText);
                rauAdapter.setfilter(filterModList);
                return true;
            }
        });
