...
import com.example.myshop.adapter.LauAdapter;
...
public class LauActivity extends AppCompatActivity {
    androidx.appcompat.widget.Toolbar toolbarlau;
    ListView listView;
    ...
    private void LoadMoreData() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                SanPham product = (SanPham) lauAdapter.getItem(position);
                ...
                if(response!=null && response.length()!=2){
                    ...
                    try {
                        ...
                        for (int i=0;i<jsonArray.length();i++){
                            ...
                            manglau.add((new SanPham(ID,Tensanpham,Hinhanhsanpham,Giasanpham,Mau,ChatLieu,Motasanpham,IDtype)));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                final List<SanPham> filterModList = filter(manglau, newText);
                lauAdapter.setfilter(filterModList);
                return true;
            }
        });
